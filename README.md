...
Целью данного проекта является создание такого сайта спортивного клуба, который заинтересует любого человека, посетившего страницу.
...
Главным преимуществом данного тренажёрного зала может стать расписание тренировок с возможностью онлайн записи. Эта функция позволит клиенту сразу выбрать удобное время у понравившегося тренера, без необходимости оставлять заявку или звонить операторам.
...
Изучаем потребности клиентов, исследуем конкурентов. Продумываем структуру и дизайн. Согласовываем всё с заказчиком. Тестируем и передаём заказчику. В конце записываем обучающее видео, чтобы сотрудники сами могли администрировать сайт.
***
## 2.1 Этап проектирования <a name="проектирование"></a>
Проектирование началось с анализа опыта работы сайтов других тренажёрных залов, выявления их плюсов и минусов. После, на основе полученных данных, необходимо было создать собственный сайт так, чтобы с момента знакомства с ним посетитель убеждался в выгодности и привлекательности предложения фитнес-клуба.

Что для этого сделали: 
1. Изучили симпатии и антипатии клиентов в отношении современных сайтов. 
2. Проанализировали конкурентов, которых в зоне данного спортивного клуба обнаружилось предлстаточно. Однако у кого-то из них устаревший дизайн, неоправданно завышенные цены, у некоторых сайт оказался давно уже заброшенным. 
...
4. Особенно важно было показать при разработке сайта, что деятельность фитнес-центра организована на очень высоком профессиональном уровне. Все сотрудники высококвалифицированные, каждый тренер получил академическое образование по фитнесу.
***
