...
3. Необходимо показать, что услуги предназначаются всем, кто в них заинтересован - для профессиональных спортсменов, для тех, кто может посещать занятия в обеденный перерыв, после работы, по выходным или рано утром. - text in red
...
| Зал | Дизайн |
|---|---|
| №1 | Скучные цвета, маленький шрифт, не привлекает внимания |
| №2 | Перебор ярких, не сочетающихся друг с другом цветов, режет глаза, шрифт везде разный |
| №3 | Акцент на одном ярком цвете, дизайн сочетается с оформлением помещения в реале, всё смотрится гармонично |
...
| Зал | Инструкторы |
|---|---|
| №1 | Не хватает информации об инструкторах, работающих в студии |
| №2 | Нет информации об инструкторах: кто они, где обучались, сколько лет преподают |
| №3 | Полная информация об инструкторах: ФИО, стаж работы, дата рождения, номер телефона, расписание |

| Зал | Описание зала |
|---|---|
| №1 | Не хватает большей спецификации тренажеров |
| №2 | Не хватает информации о том, какие тренажеры есть |
| №3 | Полная информация об имеющихся тренажерах, включая фото и видео |

| Зал | Новости |
|---|---|
| №1 | Отсутствуют |
| №2 | Вносятся редкие изменения |
| №3 | Регулярные обновления, включая фото и видео с тренировок |
...
При разработке информационной системы я пользовалась следующими сайтами:
