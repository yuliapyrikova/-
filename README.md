...
|                                                                                                   Дизайн                                                                                        |
|-----------------------------------------------------------------|-------------------------------------------------------------|-----------------------------|-----------------------------------|
|Cтандартно, не цепляет взгляд, не соответствует дизайну помещения|Слишком ярко, режет глаза, не соответствует дизайну помещения|Интересно и оригинально, цепляет и соответствует дизайну помещения|
|-----------------------------------------------------------------------------------------------------------------------------|
||||
||||
||||
