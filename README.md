...
|      Дизайн      |              №1                  |                 №2                |                №3                 |
|------------------|----------------------------------|-----------------------------------|-----------------------------------|
|                  |Cтандартно, не цепляет взгляд,    |Слишком ярко, режет глаза,         |Интересно и оригинально, цепляет   |
|                  |не соответсвует дизайну помещения |не соответствует дизайну помещения |и соответствует дизайну помещения  |
|-----------------------------------------------------------------------------------------------------------------------------|
||||
||||
||||
