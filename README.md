...
## 2 Сравнительный анализ существующих решений <a name="решение_проблемы"></a>
Может быть проблема уже решена до нас.
...
## 2.1 Проектирование информационной системы <a name="проектирование"></a>
...
## 2.2 Реализация информационной системы <a name="реализация"></a>
в процессе
***
